...
def level_one(name):
    ...
    while True:
        ...
        print("Level 1")
        country_code = input(
            f"You're currently at {current_location[1]}. Which country would you like to explore next? Enter the country code (e.g., US, FI): ")
        ...
        if events == 1:
            ...
            print(
                "Landing time! The weather is sunny. Landing will be easy. Grab your controls and get ready to land the plane!")
            time.sleep(4)
            if function.press_arrow_keys_fast(3.0) == 1:
                function.change_point_win(name)
                print("+1 point")
...
def level_two(name):
    ...
    while True:
        ...
        if events == 1:
            ...
            print(
                "Landing time! The weather is cloudy. Landing will be a little more difficult. Grab your controls and get ready to land the plane!")
            time.sleep(4)
            if function.press_arrow_keys_fast(2.5) == 1:
                function.change_point_win(name)
                print("+1 point")
...
def level_three(name):
    ...
    while True:
        ...
        if events == 1:
            ...
            print(
                "Landing time! The weather is rainy. Landing will be a little more difficult than the last one. Grab your controls and get ready to land the plane!")
            time.sleep(4)
            if function.press_arrow_keys_fast(2.0) == 1:
                function.change_point_win(name)
                print("+1 point")
...
def level_four(name):
    ...
    while True:
        ...
        if events == 1:
            ...
            print(
                "Landing time! The weather is windy. Landing will be a little more difficult than the last one. Grab your controls and get ready to land the plane!")
            time.sleep(4)
            if function.press_arrow_keys_fast(1.7) == 1:
                function.change_point_win(name)
                print("+1 point")
...
def level_five(name):
    ...
    while True:
        ...
        if events == 1:
            ...
            print(
                "Landing time! The weather is stormy. Landing will be a little more difficult than the last one. Grab your controls and get ready to land the plane!")
            time.sleep(4)
            if function.press_arrow_keys_fast(1.3) == 1:
                function.change_point_win(name)
                print("+1 point")
